...
public class menuEvent extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_menu_1 =(Button)findViewById(R.id.menu_1);
        btn_menu_2 =(Button)findViewById(R.id.menu_2);
        btn_menu_3 =(Button)findViewById(R.id.menu_3);
        btn_menu_4 =(Button)findViewById(R.id.menu_4);
        btn_menu_5 =(Button)findViewById(R.id.menu_5);
